    ...
    fun testPhpGeneratedFile() {
        ...
        assertTrue(
                cvsContent[1].size == 3 &&
                        ...
                        cvsContent[1][1].toIntOrNull() == LENGTH &&
                        cvsContent[1][2] == ALPHANUMERIC,
                "Array Header values should be like " +
                        arrayOf("integer value", LENGTH, ALPHANUMERIC)
        )
        ...
        for (i in 3 until size - 1) {
            ...
            assertTrue(
                    cvsContent[i][0].all { char -> char.isDigit() },
                    "The row should have an integer"
            )
